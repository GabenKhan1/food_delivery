...
class CartRepo {
  ...
  List<CartModel> getCartHistoryList() {
    ...
    cartListHistory.forEach((element) => cartListHistory
        .add(CartModel.fromJson(jsonDecode(element.toString()))));
    return cartListHistory;
  }

  void addToCartHistoryList() {
    if (sharedPreferences.containsKey(AppConstants.CART_LIST_HISTORY)) {
      cartHistory = sharedPreferences.getString(AppConstants.CART_LIST_HISTORY)!
          as List<String>;
    }

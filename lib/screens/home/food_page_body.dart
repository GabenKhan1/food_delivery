  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //ListView builder to show List of food
                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SmallText(
                                            text: "its available in pakistan"),
                                        SizedBox(
                                          height: Dimensions.height10,
                                        ),
                                        Row(
                        ...
                        onTap: () {
                          Get.to(RecomendedFoodDetail(
                              pageId: index, page: "home"));
                          // Get.toNamed(
                          //   RoutesHelpers.getRecommendedFood(index, "home"),
                          // );
                        },
                      );
                    },
      ...
      child: Stack(
        children: [
          GestureDetector(
            ...
            onTap: () {
              //Get.toNamed(RoutesHelpers.getPopularFood(index, "home"));
